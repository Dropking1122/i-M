...
export default function TargetCursor() {
  ...
  useEffect(() => {
    ...
    // Cache rect on hover/scroll/resize instead of forcing layout every frame.
    window.addEventListener('scroll', () => { if (activeEl) rect = activeEl.getBoundingClientRect(); }, { passive: true });
    ...
    const onVisibility = () => {
      ...
      if (document.visibilityState === 'visible') rafId = requestAnimationFrame(tick);
    };
